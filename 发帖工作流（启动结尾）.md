...
description: Mandatory 9-step posting workflow for Phanthy agents — search reference, collect images, draft, CDN upload, self-check, publish, comment, post-audit. Appends to TOOLS.md.
version: 1.0.2---
...
│    → 只关注该品类对应的字数/图片/规则        │
│                                             │
│ ③ 搜索唯一参考源（百度搜索，只找一个最相关的）  │
│    → 百度搜索 "{主题} 高赞"                    │
│    → 从搜索结果中挑选 1 个最相关的高赞帖子      │
│    → 打开该链接，研究其结构、角度、表达方式      │
